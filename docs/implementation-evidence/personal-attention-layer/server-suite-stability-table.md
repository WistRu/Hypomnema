...
Then four consecutive runs of the mandated command itself,
`corepack pnpm test`, with the completeness guard active:
...
| # | item | met? |
|---|---|---|
| 1 | ten consecutive passes of the mandated command, recorded like #28's table | **no** — four mandated runs, plus six of the server suite alone |
...
Two of four, and one of those two only partly. The issue stays open.
