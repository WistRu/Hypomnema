...
После подключения откройте `/mcp` в Codex и убедитесь, что `tabhub` и восемь инструментов доступны.
...
- Этапы 5–7: см. [план реализации](./tab-manager-plan.md).
